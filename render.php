...
class local_hotquestion_renderer extends plugin_renderer_base {
	...
	return this->html_writer::alist($toolbuttons, array('id' => 'toolbar'));   
}
   
    // display question list
    function display_questionlist($hotquestion, $cm, $course) {
	global $DB;	
	...
	if ($questions) {
	    ...
	    return this->html_writer::table($table);	
        }
        else {
	    return this->box(get_string('noquestions', 'hotquestion'), 'center', '70%');
        }
    }
}
